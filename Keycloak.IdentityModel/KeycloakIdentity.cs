...
namespace Keycloak.IdentityModel
{
    public class KeycloakIdentity : ClaimsIdentity, IIdentity
    {
        ...
        //    foreach (var claim in _accessToken.Claims)
        //    {
        //        claims.AppendLine(claim.ToString() + ", ");
        //    }
                ...
                string state = null)
        {
            ...
            var loginUri = new Uri(loginUrl + (!string.IsNullOrEmpty(loginQueryString) ? "?" + loginQueryString : ""));
